/**
 * File to add JavaScript for fastest-cache.
 *
		...
		function () {
			...
			if ( news_section.length > 0 ) {
				...
				jQuery.get(
					...
					function( data ) {
						 ...
						 *
						 * File: admin/class-fastest-cache-admin.php
						 * Method: fastest_cache_get_feeds();
						 */
			...
			jQuery( "form#purgeall a" ).click(
				function (e) {
					...
					if ( confirm( fastest_cache.purge_confirm_string ) === true ) {
