...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	class medazin_medisafe_wp_process_Customize_Control extends WP_Customize_Control {
	...
	$wp_customize->add_control(new medazin_medisafe_wp_process_Customize_Control($wp_customize,
	'process_doc_link' , 
		array(
