...
$cleverfox_theme = wp_get_theme(); // gets the current theme
	...
	$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/'.strtolower($cleverfox_theme->name).'/images/logo.png';
	$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/'.strtolower($cleverfox_theme->name).'/images';
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'medazin_media_id', $cleverfox_ImageId );
