<?php 
	$medazin_service_title 			= get_theme_mod('service_title',__('Out Standing Service','clever-fox'));
	$medazin_service_subtitle		= get_theme_mod('service_subtitle',__('Service','clever-fox'));
	$medazin_service_contents		= get_theme_mod('service_contents',medazin_get_service_default());  	
?>	
    ...
    <section id="service-section" class="service-section service-home wow fadeInUp">
        ...
        <div class="container">
			<?php if(!empty($medazin_service_title)  || !empty($medazin_service_subtitle)): ?>
				<div class="section-title text-center wow slideInDown">
					<?php if(!empty($medazin_service_subtitle)): ?>
						<span class="subtitle">
							<?php echo wp_kses_post($medazin_service_subtitle); ?>
						</span>
					<?php endif; ?>
					...
					<?php if(!empty($medazin_service_title)): ?>
						<h5>
							<?php echo wp_kses_post($medazin_service_title); ?>
						</h5>
					<?php endif; ?>
				</div>
			<?php endif; ?>
            ...
            <div class="service-content">
                <div class="row row-cols-2">
					<?php
						if ( ! empty( $medazin_service_contents ) ) {
						$medazin_service_contents = json_decode( $medazin_service_contents );
						$medazin_count = 1;
						foreach ( $medazin_service_contents as $medazin_service_item ) { 
							$medazin_repeater_image = ! empty( $medazin_service_item->image_url ) ? apply_filters( 'medazin_translate_single_string', $medazin_service_item->image_url, 'Service section' ) : '';
							$medazin_repeater_icon = ! empty( $medazin_service_item->icon_value) ? apply_filters( 'medazin_translate_single_string', $medazin_service_item->icon_value,'Service section' ) : '';
							$medazin_repeater_title = ! empty( $medazin_service_item->title ) ? apply_filters( 'medazin_translate_single_string', $medazin_service_item->title, 'Service section' ) : '';
							$medazin_repeater_text = ! empty( $medazin_service_item->text ) ? apply_filters( 'medazin_translate_single_string', $medazin_service_item->text, 'Service section' ) : '';
							$medazin_repeater_button = ! empty( $medazin_service_item->text2) ? apply_filters( 'medazin_translate_single_string', $medazin_service_item->text2,'Service section' ) : '';
							$medazin_repeater_link = ! empty( $medazin_service_item->link ) ? apply_filters( 'medazin_translate_single_string', $medazin_service_item->link, 'Service section' ) : '';
							$medazin_repeater_choice = ! empty( $medazin_service_item->choice ) ? apply_filters( 'medazin_translate_single_string', $medazin_service_item->choice, 'Service section' ) : '';
					?>
						<div class="col-lg-3 col-md-6 col-sm-6 mt-4 wow zoomIn">
							<div class="service-box">
								...
								<?php } elseif ( ! empty( $medazin_repeater_icon ) ) { ?>
									<div class="service-icon">
										<i class="fa <?php echo esc_attr($medazin_repeater_icon); ?>"></i>
									</div>
									<div class="bg-element">
										<i class="fa <?php echo esc_attr($medazin_repeater_icon); ?>"></i>
									</div>
								...
								<div class="service-content">
									...
									<?php if ( ! empty( $medazin_repeater_button ) && ! empty( $medazin_repeater_link ) ) : ?>
										<a href="<?php echo esc_url( $medazin_repeater_link ); ?>">
											<span>
												<?php echo esc_html( $medazin_repeater_button ); ?>
											</span> 
										</a>
									<?php endif; ?>	
								</div>
