...
require CLEVERFOX_PLUGIN_DIR . 'inc/news25-prime/features/news25-news-nine.php';
...
if ( ! function_exists( 'cleverfox_news25_frontpage_sections2' ) ) :
	function cleverfox_news25_frontpage_sections2() {
		...
		require CLEVERFOX_PLUGIN_DIR . 'inc/news25-prime/sections/section-news-nine.php';
    }
endif;
