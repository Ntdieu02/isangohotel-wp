...
if('Belltech' == $cleverfox_theme->name){
	$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/belltech/images/logo.png';
	$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/belltech/images';
}else{
	$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/metasoft/images/logo.png';
	$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/metasoft/images';
}	
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'metasoft_media_id', $cleverfox_ImageId );
