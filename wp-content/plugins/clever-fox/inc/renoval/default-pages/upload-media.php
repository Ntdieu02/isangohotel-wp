...
if( 'Builderse' == $cleverfox_theme->name){
	$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/builderse/images/logo.png';
	$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/builderse/images';
}elseif('Eractor'== $cleverfox_theme->name){
	$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/eractor/images/logo.png';
	$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/eractor/images';
}else{
	$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/renoval/images/logo.png';
	$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/renoval/images';
}
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'renoval_media_id', $cleverfox_ImageId );
