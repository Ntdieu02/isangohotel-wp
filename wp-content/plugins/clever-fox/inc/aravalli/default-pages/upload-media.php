...
if('Arbuda' == $cleverfox_theme->name){
	$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/arbuda/images/logo.png';
	$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/arbuda/images';
}else if('VillaPress' == $cleverfox_theme->name){
	$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/villapress/images/logo.png';
	$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/villapress/images';
}else {
	$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/aravalli/images/logo.png';
	$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/aravalli/images';
}	
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'aravalli_media_id', $cleverfox_ImageId );
