<?php
$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/thai-spa/images/logo.png';
$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/thai-spa/images';
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'hantus_media_id', $cleverfox_ImageId );
