	...
	//Pro feature
		class Avril_team__section_upgrade extends WP_Customize_Control {
			...
			<?php }elseif ( 'Evion' == $cleverfox_theme->name){ ?>	
				...
				<a class="customizer_team_upgrade_section up-to-pro" href="https://www.nayrathemes.com/evion-pro/" target="_blank" style="display: none;"><?php esc_html_e('Upgrade to Pro','clever-fox'); ?></a>
			...
			<?php }else{ ?>	
				...
				<a class="customizer_team_upgrade_section up-to-pro" href="https://www.nayrathemes.com/axtia-pro/" target="_blank" style="display: none;"><?php esc_html_e('Upgrade to Pro','clever-fox'); ?></a>
