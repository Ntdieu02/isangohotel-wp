...
$theme = wp_get_theme(); // gets the current theme
	...
	//Pro feature
		class Webique_slider__section_upgrade extends WP_Customize_Control {
			...
			?>		
				<a class="customizer_slider_upgrade_section up-to-pro" href="<?php echo webique_premium_links(); ?>" target="_blank" style="display: none;"><?php esc_html_e('Upgrade to Pro','clever-fox'); ?></a>
			<?php
			}
		}
