...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	//Pro feature
		class Webique_cta_client__section_upgrade extends WP_Customize_Control {
			...
			?>
			<a class="customizer_cta_client_upgrade_section up-to-pro" href="<?php echo webique_premium_links(); ?>" target="_blank" style="display: none;"><?php esc_html_e('Upgrade to Pro','clever-fox'); ?></a>
			<?php
			}
		}
	...
	//Pro feature
		class Webique_cta___pro_upgrade extends WP_Customize_Control {
			public function render_content() { 
			?>		
				<a class="customizer_slider_upgrade_section up-to-pro" href="<?php echo webique_premium_links(); ?>" target="_blank"><?php esc_html_e('Unlock By Upgrade to Pro','clever-fox'); ?></a>
			<?php
			}
		}
