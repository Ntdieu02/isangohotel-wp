...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';	
	...
	if ( class_exists( 'Cleverfox_Customizer_Range_Slider_Control' ) ) {
		...
		class Webique_site_typo__upgrade extends WP_Customize_Control {
			...
			?>
				<a class="customizer_site_typo_upgrade_section up-to-pro" href=<?php echo webique_premium_links(); ?>" target="_blank""><?php esc_html_e('Unlock By Upgrade to Pro','clever-fox'); ?></a>
	...
	//Pro feature
		class Webique_social__section_upgrade extends WP_Customize_Control {
			public function render_content() { 
			?>
			 <a class="customizer_social_upgrade_section up-to-pro"  href="<?php echo webique_premium_links(); ?>" target="_blank"  style="display: none;"><?php esc_html_e('Upgrade to Pro','clever-fox'); ?></a>
			<?php
			}
		}
	 ...
	 */
		...
		class Webique_header_animation__section_upgrade extends WP_Customize_Control {
			public function render_content() { 
			?>
			<a class="customizer_header_animation_upgrade_section up-to-pro"  href="<?php echo webique_premium_links(); ?>" target="_blank"  style="display: none;"><?php esc_html_e('Upgrade to Pro','clever-fox'); ?></a>
			<?php
			}
		}
