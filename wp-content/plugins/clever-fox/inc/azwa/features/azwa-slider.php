...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	 ...
	 */
		...
		class Conceptly_slider__section_upgrade extends WP_Customize_Control {
			...
			?>
				<a class="customizer_slider_upgrade_section up-to-pro" href="https://www.nayrathemes.com/conceptly-pro/" target="_blank" style="display: none;"><?php esc_html_e('Upgrade to Pro','clever-fox'); ?></a>
			<?php
			}
			}
		}
...
function conceptly_home_slider_section_partials( $wp_customize ){
	...
	$wp_customize->selective_refresh->add_partial( 'slider', array(
		...
		'settings'            => 'slider',
		'render_callback'  => 'conceptly_azwa_home_section_slider_render_callback',
...
// Slider
function conceptly_azwa_home_section_slider_render_callback() {
