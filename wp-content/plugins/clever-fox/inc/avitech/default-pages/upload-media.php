<?php
$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/avitech/images/logo.png';
$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/avitech/images';
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'avril_media_id', $cleverfox_ImageId );
