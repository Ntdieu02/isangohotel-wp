<?php
$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/eduvert/images/logo.png';
$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/eduvert/images';
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'eduvert_media_id', $cleverfox_ImageId );
