<?php
$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/boostify/images/logo.png';
$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/boostify/images';
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'boostify_media_id', $cleverfox_ImageId );
