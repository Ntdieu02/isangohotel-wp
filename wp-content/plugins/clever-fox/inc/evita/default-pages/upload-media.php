<?php
$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/evita/images/logo.png';
$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/evita/images';
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'evita_media_id', $cleverfox_ImageId );
