...
require CLEVERFOX_PLUGIN_DIR . 'inc/news25-live/features/news25-news-seven.php';
...
if ( ! function_exists( 'cleverfox_news25_frontpage_sections2' ) ) :
	function cleverfox_news25_frontpage_sections2() {
		...
		require CLEVERFOX_PLUGIN_DIR . 'inc/news25-live/sections/section-news-seven.php';
    }
endif;
