...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	class nexcraft_wp_funfact_Customize_Control extends WP_Customize_Control {
	public $type = 'new_menu';
	   ...
	   ?>
			...
			<p><?php echo esc_html__('Frontpage Section > funfact Section','clever-fox'); ?> <br><br> <a href="#" style="background-color:#03c281; color:#fff;display: flex;align-items: center;justify-content: center;text-decoration: none;   font-weight: 600;padding: 15px 10px;"><?php echo esc_html__('Click Here','clever-fox'); ?></a></p>
	...
	$wp_customize->add_control(new nexcraft_wp_funfact_Customize_Control($wp_customize,
	'funfact_doc_link' , 
		array(
