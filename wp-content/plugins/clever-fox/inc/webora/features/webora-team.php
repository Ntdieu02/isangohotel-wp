...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	if ( 'Webora' === $clever_fox_theme->get( 'Name' ) ) :
		...
		class Webique_team__section_upgrade extends WP_Customize_Control {
			...
			?>		
				<a class="customizer_team_upgrade_section up-to-pro" href="<?php echo webique_premium_links(); ?>" target="_blank" style="display: none;"><?php esc_html_e('Upgrade to Pro','clever-fox'); ?></a>
			<?php
			}
		}
	...
	//Pro feature
		class Webique_team_pro_upgrade extends WP_Customize_Control {
			public function render_content() { 
			?>		
				<a class="customizer_team_upgrade_section up-to-pro" href="<?php echo webique_premium_links(); ?>" target="_blank"><?php esc_html_e('Unlock By Upgrade to Pro','clever-fox'); ?></a>
			<?php
			}
		}
