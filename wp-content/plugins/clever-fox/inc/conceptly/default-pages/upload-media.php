<?php
$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/conceptly/images/logo.png';
$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/conceptly/images';
    ...
    if (!is_wp_error($cleverfox_remote_content) && $cleverfox_remote_content['response']['code'] === 200) {
        ...
        if (!$cleverfox_upload_file['error']) {
            ...
            $cleverfox_attachment = array(
                ...
                'post_excerpt' => 'conceptly caption',
                'post_status' => 'inherit'
            );
