<?php
$cleverfox_file = CLEVERFOX_PLUGIN_URL .'inc/startbiz/images/logo.png';
$cleverfox_ImagePath = CLEVERFOX_PLUGIN_URL .'inc/startbiz/images';
...
foreach($cleverfox_images as $cleverfox_name) {
 ...
 update_option( 'startkit_media_id', $cleverfox_ImageId );
