 ...
 */
	...
	wp.customize.controlConstructor['aravalli-sortable'] = wp.customize.Control.extend({
...
/**
 *Aravalli Radio Image
 */
 
jQuery( document ).ready( function() {
	jQuery( '.customize-control-aravalli-radio-image' ).buttonset();
} );