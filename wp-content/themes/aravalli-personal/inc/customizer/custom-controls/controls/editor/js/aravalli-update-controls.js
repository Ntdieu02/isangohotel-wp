            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result !== '' && result !== 'undefined' ){
                        ...
                        jQuery( '#Aravalli_Page_Editor' ).val(content);
                        WPEditorWidget.setEditorContent('Aravalli_Page_Editor');
                        ...
                        if(result.post_thumbnail !== '' && result.post_thumbnail !== 'undefined'){
                            ...
                            var html = '<label for="aravalli_feature_thumbnail-button">' +
                                ...
                                '<button type="button" class="button upload-button control-focus" id="aravalli_feature_thumbnail-button">Change Image</button> ' +
