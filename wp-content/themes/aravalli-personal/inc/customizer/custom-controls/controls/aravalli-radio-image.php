...
/**
 * Aravalli
 * Customizer Control: Aravalli Radio Image control
 */

class Aravalli_Customize_Control_Radio_Image extends Aravalli_Customize_Base_Control {
	/**
	 ...
	 * @var   string
	 */
	public $type = 'aravalli-radio-image';
	/**
	...
	public function render_content() {
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>" class="aravalli-radio-image-select">
