 ...
 */
function aravalli_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function aravalli_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function aravalli_sanitize_html( $html ) {
 ...
 */
function aravalli_sanitize_image( $image, $setting ) {
 ...
 */
function aravalli_sanitize_nohtml( $nohtml ) {
 ...
 */
function aravalli_sanitize_number_absint( $number, $setting ) {
 ...
 */
function aravalli_sanitize_select( $input, $setting ) {
 ...
 */
function aravalli_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function aravalli_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function aravalli_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
...
function aravalli_sanitize_sortable( $val, $setting ) {
...
function aravalli_sanitize_typography_fonts( $input ) {
	$standard = aravalli_font_selector_get_standard_fonts();
	$google = aravalli_font_selector_get_google_fonts_array();
